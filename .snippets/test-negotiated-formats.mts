...
// SNIPEND basic-format-check

console.log();

// SNIPSTART quality-validation
...
// SNIPEND quality-validation

console.log();

// SNIPSTART fallback-testing
